...
from colibri.tests.conftest import T0_PDFSET, TEST_FULL_DIS_DATASET, TEST_FULL_POS_DATASET, TEST_FULL_HAD_DATASET, TEST_FULL_GLOBAL_DATASET
...
@pytest.mark.parametrize("wmin_model_settings", [TEST_WMIN_SETTINGS_NBASIS_10, TEST_WMIN_SETTINGS_NBASIS_20])
...
def test_likelihood_dis_wmin_with_pos(wmin_model_settings):
    ...
    """
    # get chi2 with no positivity
    loss_function = colibriAPI.make_chi2_with_positivity(**{**TEST_FULL_DIS_DATASET, **TEST_FULL_POS_DATASET, **T0_PDFSET})

    # get forward map
    forward_map = colibriAPI.make_pred_data(**TEST_FULL_DIS_DATASET)

    # get FIT_XGRID
    FIT_XGRID = colibriAPI.FIT_XGRID(**{**TEST_FULL_DIS_DATASET, **TEST_FULL_POS_DATASET})
...
def test_likelihood_had_wmin_with_pos(wmin_model_settings):
    ...
    """
    # get chi2 with no positivity
    loss_function = colibriAPI.make_chi2(**{**TEST_FULL_HAD_DATASET, **TEST_FULL_POS_DATASET, **T0_PDFSET})

    # get forward map
    forward_map = colibriAPI.make_pred_data(**{**TEST_FULL_HAD_DATASET, **TEST_FULL_POS_DATASET})

    # get FIT_XGRID
    FIT_XGRID = colibriAPI.FIT_XGRID(**{**TEST_FULL_HAD_DATASET, **TEST_FULL_POS_DATASET})
...
def test_likelihood_global_wmin_with_pos(wmin_model_settings):
    ...
    """
    # get chi2 with no positivity
    loss_function = colibriAPI.make_chi2(**{**TEST_FULL_GLOBAL_DATASET, **TEST_FULL_POS_DATASET, **T0_PDFSET})

    # get forward map
    forward_map = colibriAPI.make_pred_data(**{**TEST_FULL_GLOBAL_DATASET, **TEST_FULL_POS_DATASET})

    # get FIT_XGRID
    FIT_XGRID = colibriAPI.FIT_XGRID(**{**TEST_FULL_GLOBAL_DATASET, **TEST_FULL_POS_DATASET})
